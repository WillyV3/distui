...
func GenerateGoReleaserConfig(project *models.ProjectInfo, config *models.ProjectConfig) (string, error) {
	...
	b.WriteString("# Generated by distui - https://github.com/willyv3/distui\n")
	...
	b.WriteString("    name_template: >-\n")
	b.WriteString("      {{ .ProjectName }}_\n")
	b.WriteString("      {{- .Version }}_\n")
	b.WriteString("      {{- title .Os }}_\n")
	b.WriteString("      {{- if eq .Arch \"amd64\" }}x86_64\n")
	b.WriteString("      {{- else if eq .Arch \"386\" }}i386\n")
	b.WriteString("      {{- else }}{{ .Arch }}{{ end }}\n")
